	...
	<body class="color-mode">
        ...
        <div class="container">
            ...
            <?php
                ...
                if($result){
                    echo '<form enctype="multipart/form-data" method="POST" action="verif_packs_update.php?id_pack='.$_GET['id_pack'].'" class="rounded" style="background-color: #FFFAFA; max-width: 1300px;">';
                    echo '            
                    <div class="row mb-3">
                            <div class="col-lg-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <h3>Prix :</h3>
                            <div class="form-outline mb-4">
                                <input type="number" id="prix" value="'.$result['prix'].'" class="form-control" name="prix"/>
                                <small id="prixHelp" class="form-text text-muted">Le prix est en euros</small>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <h3>Promotion :</h3>
                            <div class="form-outline mb-4">
                                <input type="number" id="promo" value="'.$result['promotion'].'" class="form-control" name="promo"/>
                    ...
                    <div class="row mb-3">
                            <div class="col-lg-4">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="number" id="personne" class="form-control" value="'.$result['personne'].'" name="personne"/>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <h3>Bagages :</h3>
                                <div class="form-outline mb-4">
                                    <input type="number" id="bagage" class="form-control" value="'.$result['bagage'].'" name="bagage"/>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <h3>Date départ :</h3>
                                <div class="form-outline mb-4">
                                    <input type="date" id="date" class="form-control" value="'.$result['date'].'" name="date"/>
                                </div>
                            </div>
                        </div>
